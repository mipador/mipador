    ...
    <footer className="w-full bg-cream pt-20 pb-8 px-6 md:px-12 border-t border-espresso/10">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-y-14 gap-x-10 mb-16">
          ...
          >
            ...
            <div className="flex items-center gap-3 mt-8">
              <a
                ...
                className="w-8 h-8 flex items-center justify-center rounded-xl bg-espresso/8 text-espresso/60 hover:bg-espresso hover:text-white transition-all duration-300"
              >
          ...
          >
            <p className="text-[10px] font-black uppercase tracking-[0.25em] text-espresso/60 mb-6">
          ...
          >
            ...
            {subscribed ? (
              <div className="bg-espresso/5 rounded-xl px-5 py-4">
                ...
                <p className="text-xs text-espresso/50 mt-1">{t("footer.subscribedBody")}</p>
              </div>
            ) : (
