      ...
      <main className="max-w-5xl mx-auto px-6 py-32">
        <div className="grid md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-4 md:sticky top-32">
            <p className="text-[10px] font-black uppercase tracking-[0.4em] text-espresso/40 mb-6">
              Mipador · Returns
            </p>
            ...
            <p className="text-espresso/50 font-light text-sm leading-relaxed">
          ...
          <div className="md:col-span-8 space-y-4">
            ...
            <div className="bg-linen p-10 md:p-16 rounded-3xl">
              <p className="text-[10px] font-black uppercase tracking-widest text-espresso/40 mb-6">
                The return window
              </p>
              <p className="text-3xl font-black text-espresso tracking-tight leading-snug mb-6">
                14 days to decide.
                <br />
                <span className="text-espresso/30 font-light italic text-2xl">
                  No pressure.
                </span>
              </p>
              <p className="text-espresso/55 font-light leading-relaxed text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white border border-espresso/8 rounded-xl p-8">
                <p className="text-[10px] font-black uppercase tracking-widest text-espresso/40 mb-4">
                  Exchange
                </p>
