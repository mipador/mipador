              ...
              {cartProducts.length > 0 && (
                <div className="px-6 pb-8 border-t border-espresso/10 pt-5 space-y-4">
                  ...
                  {showOrderForm && (
                    ...
                    >
                      <p className="text-[10px] font-black uppercase tracking-widest text-espresso/40 mb-5">
                  ...
                  {!showOrderForm && (
                    <button
                      ...
                      className="w-full border border-whatsapp text-whatsapp py-3.5 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-whatsapp/8 active:scale-95 transition-all"
                    >
                  ...
                  {!showOrderForm && (
                    <button
                      onClick={clearCart}
                      className="w-full text-espresso/25 text-[9px] font-black uppercase tracking-widest hover:text-espresso/50 transition-colors"
                    >
                      {t("cart.clearCart")}
                    </button>
                  )}
